...
const MainBanner = () => {
  return (
    <div className='relative'>
        <img src={assets.main_banner_bg}  alt='banner' className='w-full hidden md:block h-[500px] object-cover'/>
        ...
        <div className='absolute inset-0 flex flex-col items-center justify-end md:items-start md:justify-center pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24'>
          <h1 className='text-3xl md:text-4xl lg:text-5xl font-bold text-center md:text-left max-w-72 md:max-w-80 lg:mac-w-105 leading-tight lg:leading-15'>Freshness you can Trust, Savings you will Love!</h1>
